      ...
      <section className='FNV-SinglePage FNV-GrayBG' id='P1'>
        <div className='container'>
          <div className='row'>
            ...
            <div className='col-12'>
              <p>
                فعالیت&zwnj;های شما برای دریافت لایسنس مهندسی در کانادا، در سه دسته&zwnj; اصلی زیر قرار می&zwnj;گیرد:
              </p>
              <ul>
                <li>آنالیز</li>
                <li>طراحی</li>
              ...
              <p>
                آنچه که اهمیت دارد این است که، باید فعالیت&zwnj;های شما در این سه بخش اصلی قرار گیرد. برای مثال، موارد
                زیر در دسته فعالیت&zwnj;های مورد تایید لایسنس مهندسی در کانادا نیستند:
              </p>
              <ul>
      ...
      <section className='FNV-SinglePage FNV-WhiteBG' id='P2'>
        <div className='container'>
          <div className='row'>
            ...
            <div className='col-12'>
              <p>
                به صورت کلی، استان&zwnj;های کانادا قوانین و مقررات خاص خود را برای ارائه لایسنس مهندسی (P.Eng) دارند،
                هرچند که می&zwnj;توان گفت تا حدودی روند کار در اکثر استان&zwnj;ها مشابه است.
              </p>
              ...
              <p>
                ابتدا، قوانین و مقررات مربوط به هر استان را کامل مطالعه کنید تا از شرایط اصلی آن آگاه شوید. برای دریافت
                اطلاعات مورد نظر به سایت&zwnj;های زیر مراجعه کنید:
              </p>
              <ul>
                ...
                <li>
                  انجمن مهندسین و زمین&zwnj;شناسان حرفه&zwnj;ای نیوفاندلند و لابرادور (PEGNL) - نیوفاندلند و لابرادور
                </li>
                ...
                <li>
                  سرزمین&zwnj;های شمال غربی و انجمن مهندسین و زمین&zwnj;شناسان حرفه&zwnj;ای نوناووت (NAPEG) -
                  سرزمین&zwnj;های شمال غربی و نوناووت
                </li>
                <li>دومین گام: تکمیل پیش&zwnj;نیازهای مهندسی هر استان</li>
              </ul>
              <p>
                توصیه ما این است که ابتدا سایت سازمان مهندسی استان خود را در این مورد بررسی کنید. اما به طور کلی،
                پیش&zwnj;نیاز آکادمیک در تمامی استان&zwnj;ها مشترک است و شرایط آن به شرح زیر است:
              </p>
              <ul>
              ...
              <p>
                نکته: مدارک بالاتر از لیسانس در صورتی قابل ارائه است که هم&zwnj;راستا با لیسانس باشد. به عنوان مثال اگر
                لیسانس مهندسی برق ارائه می&zwnj;دهید، ارشد شما هم مهندسی برق باشد.
              </p>
              <ul>
              ...
              <ul>
                <li>
                  مدارک ترجمه&zwnj;شده باید از دانشگاه شما به صورت مهروموم&zwnj; شده (Sealed) مستقیم به اداره مهندسی
                  استان فرستاده شود.
                </li>
                <li>
                  مدارک تحصیلی ترجمه&zwnj;شده&zwnj; شما باید به تایید یک مهندس دارای لایسنس P.Eng برسد و سپس به اداره
                  مهندسی استان فرستاده شود. فناوران برای اعضای VIP مجموعه، تاییدیه مدرک تحصیلی را به صورت رایگان انجام
                  می&zwnj;دهد. در صورت نیاز به تایید، مدارک خود را برای ما ارسال کنید.
                </li>
              </ul>
      ...
      <section className='FNV-SinglePage FNV-GrayBG' id='P3'>
        <div className='container'>
          <div className='row'>
            ...
            <div className='col-12'>
              <p>
                همواره توصیه فناوران به داوطلبان .P.Eng این بوده است که، ابتدا اطلاعات کامل را راجع به مهندسی
                حرفه&zwnj;ای در کانادا و شرایط هر استان کسب کرده و سپس به فکر اقدام برای آن باشند. به طور کلی مراحل
                ثبت&zwnj;نام در سازمان&zwnj; اداری کانادا به شرح زیر است:
              </p>
              <ul>
              ...
              <ul>
                <li>
                  مدارک ترجمه&zwnj;شده باید از دانشگاه شما به صورت مهر و موم شده (Sealed) مستقیم به اداره مهندسی استان
                  فرستاده شود.
                </li>
                <li>
                  مدارک ترجمه&zwnj;شده&zwnj; شما باید به تایید یک مهندس با لایسنس مهندسی حرفه&zwnj;ای در کانادا برسد.
                </li>
              </ul>
              <p>
                از جمله خدمات فناوران می&zwnj;توان به این مورد اشاره کرد که، اگر برای کانادا، مهندس دارای P.Eng
                نمی&zwnj;شناسید، می&zwnj;تواند این سرویس را به شما ارائه دهد. حتما بیانیه&zwnj;های مورد نظر خود را هم به
                زبان فارسی و هم انگلیسی به مدارک خود اضافه کرده و برای ما به آدرس info@fanavaran.ca ارسال کنید. این
                خدمات فقط برای اعضای فناوران دردسترس است. (برای عضویت در فناوران کلیک کنید)
              </p>
              <ul>
                <li>
                  نکته: توجه داشته باشید که PEO تنها ترجمه&zwnj;هایی را می&zwnj;پذیرد که توسط یک مترجم معتبر ATIO یا یک
                  P.Eng کانادایی انجام شود. مترجم باید به هر دو زبان مسلط باشد، فقط در این صورت است که دقت ترجمه مورد
                  تایید قرار می&zwnj;&zwnj;گیرد. مترجم موظف است که شماره عضویت خود را ارائه کرده و هر صفحه را امضا و
                  تاریخ را زیر آن درج کند. برای تایید مدارک باید رونوشت زبان اصلی و ریزنمرات لیسانس و ارشد را برای
                  فناوران ارسال کنید. سعی کنید مدارک لیسانس و ارشد و همچنین رزومه&zwnj; خود را در یک فایل PDF برای ما
                  ارسال کنید.
                </li>
                <li>EIT و آزمون&zwnj;های تکنیکال</li>
              </ul>
              <p>
                در حالی که استان&zwnj;های کانادا به افراد کانادایی برای موقعیت&zwnj;های شغلی خود نیازمند هستند، افراد
                می&zwnj;توانند نسبت به دریافت دزیگنیشن EIT اقدام کنند. برای دریافت این لایسنس، در برخی موارد افراد پس از
                ثبت اپلیکیشن نیازمند گذراندن 4 کورس تکنیکال هستند. البته در صورت نگارش تجربیات کاری مرتبط ممکن است
                بتوانید دوره&zwnj;های تکنیکال را پشت سر بگذارید. این موضوع را به یاد داشته باشید که اگر تجربه&zwnj;های
                کاری شما در راستای رشته&zwnj; تحصیلی شما نباشد، 18 کورس تکنیکال به عنوان پیش&zwnj;نیاز به شما تعلق
                می&zwnj;گیرد.
              </p>
              <p>
                برای نگارش تجربیات کاری توجه داشته باشید که سوابق مهندسی مطابق با استانداردهای سازمان&zwnj;های مهندسی و
                استفاده از ترمینولوژی&zwnj;های دقیق و رفرال&zwnj;های مهم در پرونده شما است. سوابق کاری شما باید مطابق با
                تعریف &laquo;مهندسی در کانادا&raquo; باشد و از نظر فاکتورهای مختلف، معقول و قابل&zwnj;پذیرش باشد. برای
                اطلاع از نحوه نگارش سوابق کاری، توصیه می&zwnj;کنیم ورکشاپ تخصصی نگارش تجربیات مهندسی را مشاهده کنید.
              </p>
              <p>
                اگر به گذراندن دوره&zwnj;های تکنیکال نیازمند بودید بدانید که فناوران همراه شماست و با استفاده از اساتید
                مجرب و دانشگاهی، این دوره&zwnj;های تکنیکال را به صورت اختصاصی و نیمه&zwnj;خصوصی برای شما برگزار خواهد
                کرد. (برای ثبت&zwnj;نام کلیک کنید)
              </p>
              <p>
                توجه داشته باشید که باید شرح دروس خود را ارائه دهید و در صورت نیاز، جدول درجه&zwnj;بندی روبیک را جهت
                تطبیق نمرات داشته باشید.
              </p>
              ...
              <p>
                به این نکته دقت کنید که ممکن است به جدول Grading Rubric نیز نیاز باشد که از طریق این لینک می&zwnj;توانید
                دریافت کنید.
              </p>
            </div>
          </div>
