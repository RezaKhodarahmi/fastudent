            ...
            <div className='accordion p-0' id='FAQEngineering'>
                ...
                <div id='Question1' className='accordion-collapse collapse show' data-bs-parent='#FAQEngineering'>
                  <div className='accordion-body'>
                    <p>
                      ...
                      such as Saskatchewan. It's important to note that WES does not forward your original documents to
                      any other organization; they only provide confirmation of document authenticity.
                    </p>
                    <p>
              ...
              <div className='accordion-item'>
                <h2 className='accordion-header'>
                  ...
                  >
                    If we hold a P.Eng license in one province, are we eligible to apply for P.Eng licensure in another
                    province?
                  </button>
                </h2>
              ...
              <div className='accordion-item'>
                <h2 className='accordion-header'>
                  ...
                  >
                    Is it required to have expert certificates, transcripts, and course descriptions stamped by a P.Eng?
                  </button>
                </h2>
                ...
                <div id='Question12' className='accordion-collapse collapse' data-bs-parent='#FAQEngineering'>
                  <div className='accordion-body'>
                    <p>
                      ...
                      Additionally, you must have at least one year of Canadian work experience under the supervision of
                      a licensed engineer. It should be noted that work experience outside of Canada is acceptable as
                      long as it meets Canadian standards.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className='accordion-item'>
                <h2 className='accordion-header'>
                  ...
                  >
                    Do the grading scales used by the Iranian Engineering System Organization, such as grades 3, 2, and
                    1, have relevance in the process of obtaining a P.Eng?
                  </button>
                </h2>
                ...
                <div id='Question16' className='accordion-collapse collapse' data-bs-parent='#FAQEngineering'>
                  <div className='accordion-body'>
                    <p>
                      ...
                      demonstrating how your engineering expertise was applied to solve it. It is essential to provide a
                      clear description of the outcomes of your work. Additionally, it is advisable to follow the
              ...
              <div className='accordion-item'>
                ...
                <div id='Question17' className='accordion-collapse collapse' data-bs-parent='#FAQEngineering'>
                  <div className='accordion-body'>
                    <p>
                      If you possess a minimum of 5 years of engineering work experience in Iran, this requirement will
                      be deemed equivalent to 3 years of work experience. Moreover, if you also have at least one year
                      of Canadian work experience, you are eligible to directly apply for P.Eng without selecting the
                      EIT option. However, if you do not meet these criteria, you will initially become an EIT before
                      progressing to the P.Eng designation, in which case you should select the EIT option on the form.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className='accordion-item'>
                <h2 className='accordion-header'>
                  ...
                  >
                    Is it necessary to include details about working with engineering software in the Experience Record?
                  </button>
                </h2>
                <div id='Question18' className='accordion-collapse collapse' data-bs-parent='#FAQEngineering'>
                  <div className='accordion-body'>
                    <p>
                      The matter of software usage is quite intricate. While utilizing engineering software can simplify
                      tasks, it's important to note that you remain accountable for validating the results. Therefore,
                      if you have utilized software in your work, it is crucial to explain how you ensured the accuracy
                      of the outcomes obtained through the software.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div id='Question21' className='accordion-collapse collapse' data-bs-parent='#FAQEngineering'>
                  <div className='accordion-body'>
                    <p>
                      ...
                      and after receiving the P.Eng license, the amount Paid will be returned to you and the first year
                      of membership is free. This discount is not considered for those who have a Study Permit.
                    </p>
                  </div>
                </div>
              </div>
