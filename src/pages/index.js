...
=======
                  delay: 3000,
                  disableOnInteraction: false,
>>>>>>> 38918f2f2b5dcd3f75164538cfbe1bccf96d74f6
                }}
                pagination={{
                  clickable: true
                }}
                ...
                <SwiperSlide>
                  <div className='d-flex flex-row'>
                    <div className='col-md-4'>
                      ...
                      <p>Sample Description About Webinar or Features and Opportunities in webinar</p>
                      <span>
                        <i data-feather='calendar'></i> 27 September 2023
                      </span>
                      <span>20:00 Toronto Time | 17:00 Vancouver</span>
=======
                ...
                <SwiperSlide>
                  <div className='d-flex flex-row'>
                    <div className='col-12 col-md-5'>
                      ...
                      <div className='d-flex justify-content-between'>
                        <Link href='#' className='FNV-Btn BtnOutline PrimaryColor w-100'>See Details</Link>
                        <Link href='#' className='FNV-Btn BtnPrimary w-100'>Watch Video</Link>
                      </div>
                    </div>
                    <div className='col-md-7 d-none d-sm-none d-md-block'>
