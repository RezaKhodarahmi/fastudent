...
function Qualification() {
  ...
  const canadaLocations = {
    ...
    'Nova Scotia': ['Halifax', 'Sydney', 'Truro', 'New Glasgow', 'Glace Bay', 'Dartmouth', 'Bridgewater', 'Kentville'],
    'New Brunswick': [
      'Moncton',
      'Saint John',
      'Fredericton',
    ...
    Nunavut: ['Iqaluit', 'Rankin Inlet', 'Arviat', 'Cambridge Bay', 'Pond Inlet']
  }
  ...
  const renderStep = () => {
    switch (step) {
          ...
          <>
            ...
            <div className='row justify-content-end mt-4'>
              <div className='col-md-4'>
                <button className='FNV-Btn BtnPrimary BtnMedium w-100' onClick={validateAndNextStep}>
                  Next
                </button>
              </div>
            </div>
          ...
          <>
            ...
            {formData.englishLevel === 'کمتر از CLB 4' && (
              <p className='FNV-InfoBox-Danger'>
                پیش مشخص کردن فاکتورهای دیگر، باید ابتدا سطح زبان خود را تقویت کنید. لطفا از طریق کالج ITD ونکوور برای
                این منظور اقدام بفرمایید.
              </p>
            )}
            ...
            {(formData.englishLevel === 'کمتر از CLB 4' ||
              ...
              <p className='FNV-InfoBox-Warning'>
                آیا می‌دانستید فناوران در همکاری با کالج ITD کانادا (مستقر در ونکوور) دوره‌های تقویت زبان انگلیسی به
                صورت تخصصی مطابق با فیلد کاری شما برگزار می‌کند.
              </p>
            )}

            <p className='FNV-InfoBox-Default'>
              زبان انگلیسی مهمترین اسکیل برای موفقیت مهاجران در کانادا است. حتی اگر لایسنس و سرتیفیکیت‌های حوزه شغلی خود
              را دریافت کرده باشید و از سابقه کار خوبی هم برخودار باشید، بدون داشتن دانش قوی زبان انگلیسی، شانس موفقیت
              شما در کانادا به شدت کاهش می‌یابد.
            </p>
            ...
            <div className='row justify-content-between mt-4'>
              ...
              <div className='col-md-4'>
                <button className='FNV-Btn BtnPrimary BtnMedium w-100' onClick={validateAndGoToNextStep}>
                  Next
                </button>
              </div>
            </div>
        ...
        return (
          <>
            ...
            <div className='row'>
              ...
              <div className='col-12 mb-4'>
                ...
                >
                  ...
                  {formData.province &&
                    canadaLocations[formData.province].map(city => (
            ...
            <div className='row justify-content-between mt-4'>
              ...
              <div className='col-md-4'>
                <button className='FNV-Btn BtnPrimary BtnMedium w-100' onClick={validateCase3AndNextStep}>
                  Next
                </button>
              </div>
            </div>
        ...
        return (
          <>
            ...
            {formData.fieldOfActivity === 'Engineering' && (
              <p className='FNV-InfoBox-Default'>
                مهندسی در کانادا فقط شامل «طراحی، آنالیز و محاسبات» است. اگر فعالیت قبلی شما در این سه حوزه قرار ندارد،
                شما همچنان می‌توانید برای «لایسنس مهندسی» و فعالیت به عنوان مهندس اقدام کنید، اما آزمون‌های متعددی در
                مقابل شما قرار خواهد داشت. برای مثال، کارهای کارگاهی، مدیریت پروژه و … در دسته فعالیت‌های مهندسی قرار
                نمی‌گیرد.
              </p>
            )}
            ...
            {formData.fieldOfActivity === 'Architect' && (
              <p className='FNV-InfoBox-Default'>
                معماری در کانادا به معنای برنامه‌ریزی، طراحی و نظارت بر ساخت‌وساز ساختمان‌ها و فضاهای فیزیکی است. برای
                فعالیت به عنوان معمار و کسب «لایسنس معماری» در کانادا، شما باید تحصیلات تخصصی معماری داشته و در
                آزمون‌های لایسنس شرکت کنید. کارهای کارگاهی و اجرایی ساخت، جزو حوزه معماری محسوب نمی‌شوند.
              </p>
            )}

            {formData.fieldOfActivity === 'Project Management' && (
              <p className='FNV-InfoBox-Default'>
                مطابق با تعریف، مدیریت پروژه فرآیند رهبری یک تیم برای دستیابی به تمام اهداف پروژه در چارچوب محدودیت‌های
                داده شده است.
              </p>
            )}
            ...
            {formData.fieldOfActivity === 'Technician' && (
              <p className='FNV-InfoBox-Default'>
                مطابق با تعریف، تکنسین فنی فردی است که سابقه کار اجرایی (به عبارتی، کار یدی) دارد. بعضی از مشاغل فنی در
                کانادا نظام‌مند هستند و برای فعالیت نیاز به دریافت لایسنس دارید.
              </p>
            )}

            {formData.fieldOfActivity === 'Accounting' && (
              <p className='FNV-InfoBox-Default'>
                حسابداری حرفه‌ای است که شامل ثبت، طبقه‌بندی و گزارش‌گیری از معاملات مالی و اقتصادی یک نهاد است. در
                کانادا، برخی از حوزه‌های حسابداری به طور نظام‌مند نیازمند دریافت مدارک حرفه‌ای و عضویت در نهادهای معتبر
                هستند، تا فرد بتواند به عنوان حسابدار رسمی فعالیت کند.
              </p>
            )}
            ...
            <div className='row justify-content-between mt-4'>
              ...
              <div className='col-md-4'>
                <button className='FNV-Btn BtnPrimary BtnMedium w-100' onClick={validateCase4AndNextStep}>
                  Next
                </button>
              </div>
            </div>
          ...
          return (
            <>
              ...
              <div className='row justify-content-between mt-4'>
                ...
                <div className='col-md-4'>
                  <button className='FNV-Btn BtnPrimary BtnMedium w-100' onClick={validateCase5EngineeringAndNextStep}>
                    Next
                  </button>
                </div>
              </div>
          ...
          return (
            <>
              ...
              <div className='row justify-content-between mt-4'>
                ...
                <div className='col-md-4'>
                  <button className='FNV-Btn BtnPrimary BtnMedium w-100' onClick={validateCase5ArchitectAndNextStep}>
                    Next
                  </button>
                </div>
              </div>
          ...
          return (
            <>
              ...
              <div className='row justify-content-between mt-4'>
                ...
                <div className='col-md-4'>
                  <button className='FNV-Btn BtnPrimary BtnMedium w-100' onClick={validateCase5TechnicianAndNextStep}>
                    Next
                  </button>
                </div>
              </div>
          ...
          return (
            <>
              ...
              <div className='row justify-content-between mt-4'>
                ...
                <div className='col-md-4'>
                  <button className='FNV-Btn BtnPrimary BtnMedium w-100' onClick={validateCase6EngineeringAndNextStep}>
                    Next
                  </button>
                </div>
              </div>
          ...
          return (
            <>
              ...
              <div className='row justify-content-between mt-4'>
                ...
                <div className='col-md-4'>
                  <button className='FNV-Btn BtnPrimary BtnMedium w-100' onClick={validateCase6ArchitectAndNextStep}>
                    Next
                  </button>
                </div>
              </div>
          ...
          return (
            <>
              ...
              <div className='row justify-content-between mt-4'>
                ...
                <div className='col-md-4'>
                  <button className='FNV-Btn BtnPrimary BtnMedium w-100' onClick={validateCase6TechnicianAndNextStep}>
                    Next
                  </button>
                </div>
              </div>
      ...
      case 7:
        if (formData.fieldOfActivity === 'Engineering') {
          const engineeringExperiences = ['0 تا 3 سال', '3 سال تا 6 سال', '7 سال تا 12 سال', '12 سال به بالا']
          ...
          return (
            <>
              ...
              <div className='row justify-content-between mt-4'>
                ...
                <div className='col-md-4'>
                  <button className='FNV-Btn BtnPrimary BtnMedium w-100' onClick={validateCase7EngineeringAndNextStep}>
                    Next
                  </button>
                </div>
              </div>
          ...
          const validateCase7ArchitectAndNextStep = () => {
            if (!formData.architectLicense) {
              toast.error('لطفاً یکی از لایسنس‌ها یا سرتیفیکیت‌های موجود را انتخاب کنید.', {
          ...
          return (
            <>
              ...
              <div className='row justify-content-between mt-4'>
                ...
                <div className='col-md-4'>
                  <button className='FNV-Btn BtnPrimary BtnMedium w-100' onClick={validateCase7ArchitectAndNextStep}>
                    Next
                  </button>
                </div>
              </div>
          ...
          return (
            <>
              ...
              <div className='row justify-content-between mt-4'>
                ...
                <div className='col-md-4'>
                  <button className='FNV-Btn BtnPrimary BtnMedium w-100' onClick={validateCase7TechnicianAndNextStep}>
                    Next
                  </button>
                </div>
              </div>
          ...
          return (
            <>
              ...
              <div className='row justify-content-between mt-4'>
                ...
                <div className='col-md-4'>
                  <button className='FNV-Btn BtnPrimary BtnMedium w-100' onClick={validateCase8EngineeringAndNextStep}>
                    Next
                  </button>
                </div>
              </div>
          ...
          return (
            <>
              ...
              <div className='row justify-content-between mt-4'>
                ...
                <div className='col-md-4'>
                  <button className='FNV-Btn BtnPrimary BtnMedium w-100' onClick={validateCase8ArchitectAndNextStep}>
                    Next
                  </button>
                </div>
              </div>
          ...
          return (
            <>
              <div
                ...
                style={{ height: '50px' }}
              >
                <div className='progress-bar progress-bar-striped progress-bar-animated' style={{ width: '90%' }}>
                  90%
                </div>
              </div>
          ...
          return (
            <>
              ...
              <div className='row justify-content-between mt-4'>
                ...
                <div className='col-md-4'>
                  <button className='FNV-Btn BtnPrimary BtnMedium w-100' onClick={() => alert('Form Submitted')}>
                    تکمیل اطلاعات
                  </button>
                </div>
              </div>
          ...
          return (
            <>
              ...
              <div className='row justify-content-between mt-4'>
                ...
                <div className='col-md-4'>
                  <button className='FNV-Btn BtnPrimary BtnMedium w-100' onClick={handleNextStep}>
                    Next
                  </button>
                </div>
              </div>
      ...
      default:
        if (formData.fieldOfActivity === 'Engineering') {
          ...
          const generateReportContent = formData => {
            ...
            const getStrengths = () => {
              const strengths = []
              if (ageRange === 'Under 30' || (ageRange && ageRange.startsWith('30') && ageRange < '50'))
                strengths.push('محدوده سنی ایده‌آل')
              if (province === 'انتاریو') strengths.push('سکونت در استان انتاریو با فرصت‌های شغلی زیاد')
              if (['آلبرتا', 'بریتیش کلمبیا', 'کبک'].includes(province))
                strengths.push('سکونت در استانی با فرصت‌های کاری نسبتا خوب')
            ...
            const getWeaknesses = () => {
              ...
              if (!['آلبرتا', 'انتاریو', 'بریتیش کلمبیا', 'کبک'].includes(province))
                weaknesses.push('سکونت در استانی با فرصت‌های کاری کم')
            ...
            const getOpportunities = () => {
              ...
              if (['آلبرتا', 'انتاریو', 'بریتیش کلمبیا', 'کبک'].includes(province))
                opportunities.push('موقعیت‌های شغلی نسبتا خوب')
              if (!engineeringLicense || engineeringLicense === 'هیچکدام')
                opportunities.push('امکان اقدام برای دریافت لایسنس مهندسی')
            ...
            const detailedSection = () => {
              const languageLevelText =
                englishLevel === 'کمتر از CLB 7'
                  ? 'ضعیف'
                  : englishLevel === 'بیشتر از CLB 7 و کمتر از CLB 10'
                  ? 'متوسط'
                  : 'قوی'

              const experienceLevelText =
                engineeringExperience === '0 تا 3 سال'
                  ? '(Junior Level)'
                  : engineeringExperience === '3 سال تا 6 سال'
                  ? '(Intermediate Level)'
                  : engineeringExperience === '7 سال تا 12 سال'
                  ? '(Senior Level)'
                  : '(Lead Level)'

              const ageText =
                ageRange === 'Under 30' || (ageRange && ageRange.startsWith('30') && ageRange < '50')
                  ? 'ایده‌آل'
                  : ageRange && ageRange.startsWith('50')
                  ? 'ضعیف'
                  : 'متوسط'
              ...
              return (
                <>
                  <p style={{ fontSize: '18px' }}>
                    سطح زبان شما <strong style={{ color: getColor(languageLevelText) }}>{languageLevelText}</strong>{' '}
                    است. برای فعالیت مهندسی، سطح زبان شما باید متوسط رو به بالا باشد.
                  </p>
                  <p style={{ fontSize: '18px' }}>
                    براساس سابقه کار انتخابی، شما در رده <strong>{experienceLevelText}</strong> قرار دارید. سایر
                    فاکتورها را بررسی کنید.
                  </p>
                  <p style={{ fontSize: '18px' }}>
                    براساس محدوده سنی، شانس کاریابی شما <strong>{ageText}</strong> است. سایر فاکتورها را بررسی کنید.
                  </p>
                  <p style={{ fontSize: '18px' }}>
                    براساس شهر یا استان محل سکونت، شانس کاریابی در زمینه مهندسی <strong>{provinceText}</strong> است.
                    سایر فاکتورها را بررسی کنید.
                  </p>
                </>
              )
            }
            ...
            const recommendations = () => {
              ...
              if (!engineeringLicense || engineeringLicense === 'هیچکدام') {
                ...
                recommends.push(
                  'لایسنس BCIN- تنها ساکنان استان انتاریو (میزان اعتبار: متوسط - فرایند دریافت نسبتا آسان)'
                )
              }
              ...
              recommends.push(
                'شما می‌توانید برای دریافت لایسنس Energy Advisory نیز اقدام کنید. انرژی ادوایزری یک موقعیت شغلی آینده‌دار و پرتقاضا در کانادا است. برای دریافت لایسنس نیازی به سابقه کار یا مدرک تحصیلی خاصی ندارید و تنها کافیست از سد دو آزمون Foundation‌ و House بگذرید.'
              )

              // BCIN License details
              recommends.push('درباره لایسنس BCIN بیشتر بدانید:')
              recommends.push(
                'فرایند دریافت لایسنس مهندسی در کانادا بسیار سخت، طاقت فرسا و زمان‌بر است. اگر می‌خواهید هرچه زودتر وارد بازار کار شوید (تا زمانی که لایسنس مهندسی خود را دریافت کنید) راه جایگزین دریافت لایسنس BCIN است. BCIN یک لایسنس محدود محسوب می‌شود که با داشتن آن می‌توانید در زمینه طراحی ساختمان‌هایی با متراژ کمتر از ۶۰۰ متر مربع فعالیت کنید. (ویژه مهندسان و معماران)'
              )
              ...
              recommends.push(
                'چنانچه قصد دارید تا هرچه زودتر وارد بازار کار شوید؛ دریافت لایسنس BCIN یا دریافت لایسنس Energy Advisory'
              )

              return recommends.map((recommend, index) => (
                <p style={{ fontSize: '18px', lineHeight: '32px' }} key={index}>
                  {recommend}
                </p>
              ))
            }
            ...
            return (
              <>
                <p style={{ fontSize: '18px' }}>تبریک! شما اولین قدم برای کاریابی در کانادا را برداشتید!</p>
                <p style={{ fontSize: '18px' }}>
                  <strong>{name}</strong> عزیز! از اینکه به ما اعتماد کردید سپاسگذاریم. براساس موارد انتخابی، گزارشی
                  برای شما آماده کرده‌ایم تا شانس کاریابی خود را ارزیابی کنید.
                </p>
                <p style={{ fontSize: '18px' }}>
                  براساس موارد انتخاب شده، شانس کاریابی شما در کانادا{' '}
                  <strong style={{ color: assessmentColor }}>{assessment}</strong> است.
                </p>
