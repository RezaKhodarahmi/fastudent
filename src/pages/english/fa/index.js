  ...
  return (
    <>
        ...
        <div className='container'>
          <div className='row FNV-Header'>
            ...
            <div className='col-12 col-md-6 col-lg-12'>
             <p>
             تسلط بر زبان انگلیسی یکی از مهارت‌های بسیار ضروری برای کسانی است که قصد مهاجرت به کشورهای انگلیسی‌زبان مانند کانادا را دارند. تدریس خصوصی زبان انگلیسی در کانادا را می‌توان یکی از مهم‌ترین گام‌ها برای مهاجران تازه‌وارد دانست. فناوران، دوره‌های ترمیک کلاس انگلیسی خصوصی را در کشور کانادا برای ایرانیان با مدرس کانادایی فراهم کرده تا در سریع‌ترین زمان، به صورت کاملا استاندارد، زبان انگلیسی خود را تقویت کنند.
             </p>
            </div>
          </div>
        </div>
        ...
        <div className='container'>
          <div className='row'>
            <div className='col-12'>
              <p>فهرست مطالب:</p>
              <ol>
                <li><Link href="#P1">تدریس خصوصی زبان انگلیسی در کانادا برای ایرانیان</Link></li>
                <li><Link href="#P2">پکیج کلاس زبان انگلیسی خصوصی برای ایرانیان</Link></li>
                <li><Link href="#P3">تدریس خصوصی با معلم نیتیو کانادایی</Link></li>
                <li><Link href="#P4">هزینه دوره های زبان در کانادا</Link></li>
                ...
                <li><Link href="#P8">توصیه فناوران به مهاجران تازه‌وارد</Link></li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <section className='FNV-SinglePage FNV-GrayBG' id='P1'>
        <div className='container'>
          <div className='row'>
            ...
            <div className='col-12'>
              <p>
              یکی از چالش‌های اصلی ایرانیان پس از مهاجرت به کانادا، زبان انگلیسی است. تفاوت زبانی بین ایران و کانادا، اصلی‌ترین دلیلی است که این مشکل را ایجاد می‌کند. استفاده از تدریس خصوصی زبان انگلیسی در کانادا اولین توصیه‌ای است که فناوران برای مهاجران تازه‌وارد به این کشور دارد. با فرض بر اینکه شما مهارت‌های فنی یا مهندسی قابل قبولی دارید و حتی توانسته‌اید لایسنس رشته خود را نیز در کانادا دریافت کنید، بدون دانش قوی زبان انگلیسی در کانادا، شانس شما برای استخدام و دریافت حقوق‌های بالا، به شدت کاهش می‌یابد و بعضا به صفر می‌رسد.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className='FNV-SinglePage FNV-WhiteBG' id='P2'>
        <div className='container'>
          <div className='row'>
            <h3>دوره‌های ترمیک زبان انگلیسی خصوصی برای ایرانیان</h3>
            <div className='col-12'>
              <p>
              دوره‌های ترمیک زبان انگلیسی خصوصی برای ایرانیان با توجه به نیازهای متقاضیان، طراحی شده‌ است. این دوره‌ها، در دو گروه عمومی (General) و تخصصی (Specialized) طراحی شده‌اند که شامل موضوعات مختلفی مانند گرامر، لغت و مکالمه در سطوح پایه و تخصصی ویژه محیط کار کانادایی هستند. از جمله ویژگی‌های این دوره‌ها می‌توان موارد زیر را نام برد:
              </p>
              <ul>
      ...
      <section className='FNV-SinglePage FNV-GrayBG' id='P3'>
        <div className='container'>
          <div className='row'>
            ...
            <div className='col-12'>
              <p>تدریس خصوصی با معلم نیتیو کانادایی به شما کمک می‌کند تا به سرعت دانش زبانی خود را تقویت کنید. مدرس نیتیو، با نیازهای شما آشناست و به شما کمک می‌کند تا به سطح مورد نظر خود در زبان انگلیسی دست یابید. تدریس خصوصی زبان انگلیسی در کانادا با مدرس نیتیو کانادایی موارد زیر کمک می‌کند:</p>
              <ul>
                <li>تصحیح اشتباهات رایج گرامری، لغوی و &hellip;</li>
                <li>کمک به افزایش دایره واژگان</li>
                <li>آشنایی کامل با اصطلاحات و واژگان رشته&zwnj;های مختلف شغلی</li>
                <li>فرهنگ کاری در کانادا</li>
                <li>تقویت مهارت&zwnj;های زبانی</li>
                <li>تقویت شنوایی</li>
                <li>افزایش اعتمادبه&zwnj;نفس در مکالمه</li>
                <li>ارائه فیدبک&zwnj;های آنی</li>
                <li>فرهنگ مکالمه درست کانادایی</li>
              </ul>
            </div>
          </div>
        </div>
