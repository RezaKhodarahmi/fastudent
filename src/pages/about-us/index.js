  ...
  return (
    <>
      ...
      <section className='FNV-About-Content FNV-BG-Highlight'>
        <div className='container'>
          <div className='row'>
            <h2 className='text-center'>{t('about-fanavaran-4')}</h2>
        ...
        <div className='container'>
          <div className='row'>
            ...
            <div className='col-12 col-md-6 p-0'>
              <div className='row ps-0 p-4'>
                <div className='col-12 text-center'>
                  <img alt='image' src='img/team/mo_amani.jpg' className='img-fluid w-75 rounded mb-4' />
            ...
            <div className='col-12 col-md-6 p-0'>
              <div className='row ps-0 p-4'>
                <div className='col-12 text-center'>
                  <img alt='image' src='img/team/babak_babaee.png' className='img-fluid w-75 rounded mb-4' />
            ...
            <div className='col-12 col-md-4 p-0'>
              <div className='row p-0'>
                <div className='col-5'>
                  <img alt='image' src='img/team/payam_mahjoub.jpg' className='img-fluid' />
                </div>
                <div className='col-7'>
                  <h4>Payam Mahjoub</h4>
            ...
            <div className='col-12 col-md-4 p-0'>
              <div className='row p-0'>
                <div className='col-5'>
                  <img alt='image' src='img/team/parham_fazlali.jpg' className='img-fluid' />
                </div>
                <div className='col-7'>
            ...
            <div className='col-12 col-md-4 p-0'>
              <div className='row p-0'>
                <div className='col-5'>
                  <img alt='image' src='img/team/reza_khodarahmi.jpg' className='img-fluid' />
                </div>
                <div className='col-7'>
            ...
            <div className='col-12 col-md-4 p-0'>
              <div className='row p-0'>
                <div className='col-5'>
                  <img alt='image' src='img/team/arezou_khanzadeh.jpg' className='img-fluid' />
                </div>
                <div className='col-7'>
            ...
            <div className='col-12 col-md-4 p-0'>
              <div className='row p-0'>
                <div className='col-5'>
                  <img alt='image' src='img/team/maryam_rajabi.jpg' className='img-fluid' />
                </div>
                <div className='col-7'>
                  <h4>Maryam Rajabi</h4>
            ...
            <div className='col-12 col-md-4 p-0'>
              <div className='row p-0'>
                <div className='col-5'>
                  <img alt='image' src='img/team/sajad_fatehi.jpg' className='img-fluid' />
                </div>
                <div className='col-7'>
                  <h4>Sajad Fatehi</h4>
                  <small className='h6 text-muted'>BSc in Software Engineering</small>
            ...
            <div className='col-12 col-md-4 p-0'>
              <div className='row p-0'>
                <div className='col-5'>
                  <img alt='image' src='img/team/khaled_hamidi.jpg' className='img-fluid' />
                </div>
                <div className='col-7'>
                  <h4>Khaled Hamidi</h4>
                  <small className='h6 text-muted'></small>
            ...
            <div className='col-12 col-md-4 p-0'>
              <div className='row p-0'>
                <div className='col-5'>
                  <img alt='image' src='img/team/bahareh_hashemi.jpg' className='img-fluid' />
                </div>
                <div className='col-7'>
            ...
            <div className='col-12 col-md-4 p-0'>
              <div className='row p-0'>
                <div className='col-5'>
                  <img alt='image' src='img/team/roya_karami.jpg' className='img-fluid' />
                </div>
                <div className='col-7'>
                  <h4>Roya Karami</h4>
            ...
            <div className='col-12 col-md-4 p-0'>
              <div className='row p-0'>
                <div className='col-5'>
                  <img alt='image' src='img/team/elnaz_yousefi.jpg' className='img-fluid' />
                </div>
                <div className='col-7'>
                  <h4>Elnaz Yousefi</h4>
            ...
            <div className='col-12 col-md-4 p-0'>
              <div className='row p-0'>
                <div className='col-5'>
                  <img alt='image' src='img/team/hesam_bagheri.jpg' className='img-fluid' />
                </div>
                <div className='col-7'>
                  <h4>Hesam Bagheri</h4>
            ...
            <div className='col-12 col-md-4 p-0'>
              <div className='row p-0'>
                <div className='col-5'>
                  <img alt='image' src='img/team/kiarash_kiarasi.jpg' className='img-fluid' />
                </div>
                <div className='col-7'>
