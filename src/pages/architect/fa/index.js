        ...
        <div className='container'>
          <div className='row'>
            ...
            <div className='col-12'>
              ...
              <img alt="image" src={appConfig.appUrl + '/img alt="image"/landings/oaa-paths-to-license.png'} className='img alt="image"-fluid' />
        ...
        <div className='container'>
          <div className='row'>
            ...
            <div className='col-12'>
              ...
              <img alt="image" src={appConfig.appUrl + '/img alt="image"/landings/pathways-to-register-as-an-architect-in-british-columbia.png'} className='img alt="image"-fluid' />
            </div>
          </div>
        </div>
      </section>
