    ...
    <>
      ...
      <nav className='navbar navbar-expand-lg FNV-Nav d-flex flex-column pb-0 pt-0'>
        <div className='container'>
          ...
          {/* OffCanvas */}
          <div className="FNV-Offcanvas offcanvas offcanvas-start" tabIndex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
            {/* OffCanvas Header */}
            <div className="offcanvas-header">
              ...
              <div className='FNV-Header-UserMenu'>
                ...
                {/* Cart */}
                <Link className='nav-link FNV_QuickAccess_Cart' href='/cart'>
