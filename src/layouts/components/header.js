    ...
    <>
      ...
      <nav className='navbar navbar-expand-lg FNV-Nav d-flex flex-column pb-0 pt-0'>
        <div className='container'>
          ...
          {/* OffCanvas */}
          <div
            className='FNV-Offcanvas offcanvas offcanvas-start'
            tabIndex='-1'
            id='offcanvasExample'
          ...
          >
            ...
            <div className='offcanvas-header'>
              ...
              <div className='FNV-Header-UserMenu'>
                {user ? (
                  <>
                    {/* Account */}
                    <div className={`dropdown FNV_QuickAccess_User ${dropdownOpen ? 'show' : ''}`}>
                      ...
                      <ul className={`dropdown-menu ${dropdownOpen ? 'show' : ''}`}>
                        ...
                        {/* Dashboard */}
                        <Link
                          href='/app/dashboards/main/'
                          onClick={e => handleFullReload(e, '/app/dashboards/main/')}
                          className='FNV-UserMenu'
                        >
                          ...
                          <span>
                            <p>{t('user-menu-title-dashboard')}</p>
                            <span>
                              <small>{t('user-menu-title-dashboard-desc')}</small>
                            </span>
                          </span>
                        </Link>
                        ...
                        {/* Certificate */}
                        <Link
                          href='/app/dashboards/certificates/'
                          onClick={e => handleFullReload(e, '/app/dashboards/certificates/')}
                          className='FNV-UserMenu'
                        >
                          <div className='FNV-UserIcon'>
                          ...
                          <span>
                            <p>{t('user-menu-title-certificate')}</p>
                            <span>
                              <small>{t('user-menu-title-certificate-desc')}</small>
                            </span>
                          </span>
                        </Link>
                        ...
                        <Link href='javascript:void(0);' className='FNV-UserMenu' onClick={handleLogout}>
                          ...
                          <span>
                            <p>{t('user-menu-title-logout')}</p>
                            <span>
                              <small>{t('user-menu-title-logout-desc')}</small>
                            </span>
                          </span>
                        </Link>
                      </ul>
                  ...
                  <>
                    ...
                    <div className={`dropdown FNV_QuickAccess_User ${dropdownOpen ? 'show' : ''}`}>
                      ...
                      <ul className={`dropdown-menu ${dropdownOpen ? 'show' : ''}`}>
                        {/* Title */}
                        <span>{t('user-menu-title-guest')}</span>

                        {/* Links */}
                        <Link href='/login' onClick={e => handleFullReload(e, '/login/')}>
                        ...
                        <Link href='/register' onClick={e => handleFullReload(e, '/register/')}>
                          <svg
                            width='25'
                            height='25'
                            viewBox='0 0 21 25'
                          ...
                          >
                            <path
                              d='M20 25C20 20.3271 14.9919 16.5286 10.5 16.5286C6.00814 16.5286 1 20.3271 1 25M10.5 12.2943C11.9397 12.2943 13.3204 11.6993 14.3385 10.6403C15.3565 9.58122 15.9284 8.14485 15.9284 6.64714C15.9284 5.14942 15.3565 3.71305 14.3385 2.65401C13.3204 1.59496 11.9397 1 10.5 1C9.0603 1 7.67957 1.59496 6.66155 2.65401C5.64353 3.71305 5.07161 5.14942 5.07161 6.64714C5.07161 8.14485 5.64353 9.58122 6.66155 10.6403C7.67957 11.6993 9.0603 12.2943 10.5 12.2943Z'
                              stroke-width='1.5'
                              fill='none'
                            />
                          </svg>
                ...
                >
                  <svg viewBox='0 0 20 21' fill='none' xmlns='http://www.w3.org/2000/svg'>
                    <g clip-path='url(#clip0_678_6984)'>
                      <path
                        d='M7.50033 18.7131C7.96056 18.7131 8.33366 18.34 8.33366 17.8797C8.33366 17.4195 7.96056 17.0464 7.50033 17.0464C7.04009 17.0464 6.66699 17.4195 6.66699 17.8797C6.66699 18.34 7.04009 18.7131 7.50033 18.7131Z'
                        stroke-width='1.66667'
                        stroke-linecap='round'
                        stroke-linejoin='round'
                      />
                      <path
                        d='M16.6663 18.7131C17.1266 18.7131 17.4997 18.34 17.4997 17.8797C17.4997 17.4195 17.1266 17.0464 16.6663 17.0464C16.2061 17.0464 15.833 17.4195 15.833 17.8797C15.833 18.34 16.2061 18.7131 16.6663 18.7131Z'
                        stroke-width='1.66667'
                        stroke-linecap='round'
                        stroke-linejoin='round'
                      />
                      <path
                        d='M0.833008 1.21338H4.16634L6.39967 12.3717C6.47588 12.7554 6.6846 13.1 6.9893 13.3453C7.29399 13.5906 7.67526 13.7209 8.06634 13.7134H16.1663C16.5574 13.7209 16.9387 13.5906 17.2434 13.3453C17.5481 13.1 17.7568 12.7554 17.833 12.3717L19.1663 5.38005H4.99967'
                        stroke-width='1.5'
                        stroke-linecap='round'
                        stroke-linejoin='round'
                      />
                  ...
                  <span>{cartItems?.length ? <i data-feather='circle'></i> : ''}</span>
                </Link>

                {/* Phone */}
                <Link className='FNV_QuickAccess_Phone' href='tel:+19055052323'>
            ...
            <div className='offcanvas-body'>
                    ...
                    <div className='row'>
                      <div className='col-md-9'>
                        <div className='nav h-auto' id='membership-tab' role='tablist' aria-orientation='horizontal'>
                          ...
                          <button
                            className='nav-link active'
                            id='membership-overview-tab'
                            data-bs-toggle='pill'
                            data-bs-target='#membership-overview'
                            type='button'
                            role='tab'
                            aria-controls='membership-overview'
                            aria-selected='true'
                          >
                        ...
                        <div className='tab-content' id='membership-tabContent'>
                          ...
                          <div
                            ...
                            role='tabpanel'
                            aria-labelledby='membership-overview-tab'
                            tabindex='0'
                          >
                            <li>
                              <Link href='/membership/checkout'>{t('menu-membership-button')}</Link>
                            </li>
                            <li>
                              <Link href='#'>{t('menu-membership-details')}</Link>
                            </li>
                            <li>
              ...
              <div className='FNV-Canvas-Search'>
                ...
                <span className='nav-link'>
                  ...
                  <Input
                    type='text'
                    placeholder={t('search-menu-input')}
                    fullWidth
                    autoFocus
                    className='FNV-Canvas-Search-Input'
                    value={searchInput}
                ...
                {/* Title */}
                <List className='FNV-Canvas-Search-Result'>
                  {courses.length ? (
            ...
            <div className='offcanvas-footer'>
              <Button onClick={e => changeLanguage()}>{t('menu-language')}</Button>
            </div>
          </div>
          ...
          <div className='FNV_QuickAccess justify-content-end'>
            ...
            {/* Cart */}
            <Link className='nav-link' href='/cart' onClick={e => handleFullReload(e, '/cart/')}>
              <svg viewBox='0 0 20 21' fill='none' xmlns='http://www.w3.org/2000/svg'>
                <g clip-path='url(#clip0_678_6984)'>
                  <path
                    d='M7.50033 18.7131C7.96056 18.7131 8.33366 18.34 8.33366 17.8797C8.33366 17.4195 7.96056 17.0464 7.50033 17.0464C7.04009 17.0464 6.66699 17.4195 6.66699 17.8797C6.66699 18.34 7.04009 18.7131 7.50033 18.7131Z'
