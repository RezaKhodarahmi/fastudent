...
const AccountSettings = ({ tab }) => {
  // ** State
  const [activeTab, setActiveTab] = useState(tab || 'account') // Default value set to 'account'
  ...
  const handleChange = (event, value) => {
    ...
    router.push(`/app/pages/account-settings/${value.toLowerCase()}`).then(() => setIsLoading(false))
  }
