            ...
            <div className='container'>
              <div className='row'>
                <div className='col-12'>
                  <div className='row'>
                    <div className='col-3'>
                      <svg width="405" height="343" viewBox="0 0 405 343" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='col-3'>
                      <Link href="https://sponsorship.mehregan.vip/" target='_blank'>اسپانسر</Link>
                    </div>

                    <div className='col-3'>
                      <Link href="https://mehregan.vip/" target='_blank'>تهیه بلیط</Link>
                    </div>
                ...
                <div className='col-3'>
                  <img src={appConfig.appUrl + '/images/slider/mehregan_item_1.png'} className='img-fluid w-100' />
                </div>

                <div className='col-3'>
                  <img src={appConfig.appUrl + '/images/slider/mehregan_item_2.png'} className='img-fluid w-100' />
                </div>

                <div className='col-3'>
                  <img src={appConfig.appUrl + '/images/slider/mehregan_item_3.png'} className='img-fluid w-100' />
                </div>

                <div className='col-3'>
                  <img src={appConfig.appUrl + '/images/slider/mehregan_item_4.png'} className='img-fluid w-100' />
                </div>
              </div>
            </div>
          </div>
